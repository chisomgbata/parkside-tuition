<x-default-layout>
    <section class="overflow-hidden">
        <div class="relative  overflow-hidden container mx-auto"
            ...
            <livewire:header/>
            <div class="pt-12 pb-28 md:pb-72 bg-white">
                <div class="container px-4 mx-auto">
                    <div class="mx-auto text-center max-w-3xl">
                        <h1 class="mb-6 text-3xl md:text-5xl lg:text-6xl leading-tight font-bold tracking-tighter">
                            Teacher at your doorstep</h1>
                        <p class="mb-8 mx-auto text-lg md:text-xl text-coolGray-500 font-medium max-w-3xl">Unlock Your
                            Academic Potential with Parksidetuition - The Revolutionary Learning Experience</p>
        ...
        <div class="container px-4 py-20 md:pb-32 mx-auto -mt-32 md:-mt-72">
            <div class="relative mx-auto max-w-max">
                <img class="absolute -right-8 -bottom-8 w-28 md:w-auto" src="flex-ui-assets/elements/wave-yellow.svg"
                     alt="">

                <div class="relative overflow-hidden rounded-7xl hidden md:block">
                    <img src="flex-ui-assets/images/headers/placeholder-video2.png">
                    <img
                        class="absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 min-h-full min-w-full max-w-none object-cover w-full h-full"
                        src="https://images.unsplash.com/photo-1583468982228-19f19164aee2?q=80&w=2022&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                    />
        ...
        <div class="container px-4 mx-auto">
            <div class="flex flex-wrap -mx-4">
                ...
                <div class="w-full md:w-1/2 px-4">
                    <span
                        class="inline-block py-px px-2 mb-4 text-xs leading-5 text-green-500 bg-green-100 font-medium uppercase rounded-full shadow-sm">WHY CHOOSE US</span>
                    <h2 class="mb-12 text-4xl md:text-5xl leading-tight font-bold tracking-tighter">What we offer?</h2>
                    <div class="flex flex-wrap -mx-4 text-center md:text-left">
                        <div class="w-full md:w-1/2 px-4 mb-8">
                            <div
                                class="inline-flex items-center justify-center mb-4 w-12 h-12 text-xl text-white bg-green-500 font-semibold rounded-full">
                                1
                            </div>
                            <h3 class="mb-2 text-xl font-bold">Online and In-Person Tuition</h3>
                            <p class="font-medium text-coolGray-500">
                                Helping your student get ready for the future
                            </p>
                        </div>
                        <div class="w-full md:w-1/2 px-4 mb-8">
                            <div
                            ...
                            <h3 class="mb-2 text-xl font-bold">Improved Study Skills and Exam preparation</h3>
                            <p class="font-medium text-coolGray-500">
                                Teaching your child key skills to aid with their revision and get higher grades
                            </p>
                        </div>
                        <div class="w-full md:w-1/2 px-4 mb-8">
                            <div
                            ...
                            <h3 class="mb-2 text-xl font-bold">11 + Preparation</h3>
                            <p class="font-medium text-coolGray-500">Ensuring your child get into their preferred
                                school</p>
                        </div>
                        <div class="w-full md:w-1/2 px-4">
                            <div
                            ...
                            <h3 class="mb-2 text-xl font-bold">Sen Support</h3>
                            <p class="font-medium text-coolGray-500">
                                Helping support your child, whatever they need.
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <section class="py-24 md:pt-32 bg-white"
        ...
        <div class="container px-4 mx-auto">
            <div class="max-w-4xl mx-auto text-center mb-16">
                ...
                <h2 class="mb-4 text-4xl md:text-5xl leading-tight text-coolGray-900 font-bold tracking-tighter">Our
                    Subjects</h2>
                        ...
                        <div class="group h-full">
                            <div
                                ...
                                <div
                                    ...
                                    <div
                                        class="inline-flex items-center justify-center w-12 h-12 text-white bg-green-500 rounded-full">
                                        @if(isset($course['icon']))
                                            @svg($course['icon'], 'w-6 h-6')
                                        @endif


                                    </div>
                                </div>
                                <h3 class="mb-4 text-xl leading-7 text-coolGray-900 font-bold max-w-xs">{{$course['name']}}</h3>
                                <p class="text-coolGray-500 group-hover:text-coolGray-600 font-medium transition duration-200">
                                    {{$course['description']}}
                                </p>
                            </div>
                        </div>
        ...
        <div class="container px-4 mx-auto">
            <div class="flex flex-wrap mb-24 lg:mb-18 justify-between items-center">
                <div class="w-full lg:w-1/2 mb-10 lg:mb-0">
                    <span
                        class="inline-block py-px px-2 mb-4 text-xs leading-5 text-green-500 bg-green-100 font-medium uppercase rounded-9xl">Contact</span>
                    <h3 class="mb-4 text-4xl md:text-5xl text-darkCoolGray-900 font-bold tracking-tighter leading-tight">
                        Get In Touch</h3>
                    <p class="text-lg md:text-xl text-coolGray-500 font-medium">It's never been easier to get in touch
                        with us. Call us,  email and we'll get back to you as soon as possible!</p>
                </div>
                    ...
                    <div class="flex flex-wrap -mx-4">
                        <div class="w-full md:w-1/2 px-4 mb-10">
                            <div class="max-w-xs mx-auto">
                                <div
                                    class="inline-flex mb-6 items-center justify-center w-12 h-12 bg-green-500 rounded-full">
                                    <svg class="h-6 text-white" width="24" height="24" viewbox="0 0 24 24" fill="none"
                                ...
                                <h3 class="mb-4 text-2xl md:text-3xl font-bold leading-9 text-coolGray-900">Email</h3>
                                <a class="text-lg md:text-xl text-coolGray-500 hover:text-coolGray-600 font-medium"
                                   href="mailto:#">parksidetuition@gmail.com
                                </a>
                            </div>
                        </div>
                        <div class="w-full md:w-1/2 px-4 mb-10">
                            <div class="max-w-xs mx-auto">
                                ...
                                <h3 class="mb-4 text-2xl md:text-3xl font-bold leading-9 text-coolGray-900">Phone</h3>
                                <p class="text-lg md:text-xl text-coolGray-500 font-medium">07587 923174
                                </p>
                            </div>
                        </div>
                        <div class="w-full md:w-1/2 px-4 mb-10 md:mb-0">
                            <div class="max-w-xs mx-auto">
                                ...
                                <h3 class="mb-4 text-2xl md:text-3xl font-bold leading-9 text-coolGray-900">Office</h3>
                                <p class="text-lg md:text-xl text-coolGray-500 font-medium">Hounslow</p>
                            </div>
                        </div>
